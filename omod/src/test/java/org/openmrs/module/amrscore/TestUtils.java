...
public class TestUtils {
	...
	public static DrugOrder saveDrugOrder(Patient patient, Concept concept, Date start, Date end) {
		...
		DrugOrder order = new DrugOrder();
		order.setPatient(patient);
		List<Provider> provider = (List<Provider>) Context.getProviderService().getProvidersByPerson(
		    Context.getUserService().getUser(1).getPerson());
	 ...
	 * @return the drug order
	 */
	public static DrugOrder saveDrugOrder(Patient patient, Concept conceptOrdered, Concept doseUnit, Date start, Date end,
	        Encounter encounter) {
	 ...
	 * @return the drug order
	 */
	public static DrugOrder saveDrugOrderWithFreeTestInstructions(Patient patient, Concept conceptOrdered, Date start,
	        Encounter encounter) {
	...
	/**
	 * Modifies a constant in a constants class. If the constant is final and not based on a runtime
	 * expression, then it's value will have been inlined by the compiler and this method will have
	 * no effect.
	 * 
