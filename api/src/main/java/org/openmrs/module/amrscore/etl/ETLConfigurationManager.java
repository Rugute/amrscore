...
package org.openmrs.module.amrscore.etl;
...
/**
 * ETLConfiguration manager Scans through ETL extensions and build procedures for DDL, DML, and
 * Datatool
 */
@Component
public class ETLConfigurationManager implements ContentManager {
	...
	public synchronized void refresh() {
		...
		String recreateEtlsOnStartupConfig = Context.getAdministrationService().getGlobalProperty(
		    "kenyaemr.reacreate_etls_on_startup");
		
		if (recreateEtlsOnStartupConfig != null && recreateEtlsOnStartupConfig.equalsIgnoreCase("no")) {
			System.out
			        .println("Skipping recreation of ETL tables. Please set the value of kenyaemr.reacreate_etls_on_startup global property to yes to enable recreation on startup");
			return;
		}
