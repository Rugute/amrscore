...
package org.openmrs.module.amrscore.requirement;
...
public class UnsatisfiedRequirementException extends RuntimeException {
	...
	public UnsatisfiedRequirementException(Requirement requirement) {
		super("Requirement '" + requirement.getName() + "' is not satisfied. Required " + requirement.getRequiredVersion()
		        + ", but found " + requirement.getFoundVersion());
