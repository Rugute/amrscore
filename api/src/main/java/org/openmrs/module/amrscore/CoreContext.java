...
import org.openmrs.module.amrscore.api.CoreService;
...
/**
 * Core context, used as a registered singleton. Responsible for refreshing all content managers in
 * correct order.
 */
@Component
public class CoreContext {
	...
	/**
	 * Utility method to get the singleton instance from the application context in situations where
	 * you can't use @Autowired or @SpringBean. Use as a last resort.
	 * 
