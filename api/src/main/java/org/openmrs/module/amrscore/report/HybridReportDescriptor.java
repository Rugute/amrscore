...
import org.openmrs.module.amrscore.identifier.IdentifierDescriptor;
...
public class HybridReportDescriptor extends ReportDescriptor {
	...
	/**
	 * provides a string for repeating section The string is expected to specify sheet i.e 1,2 etc,
	 * row i.e 10, and dataset i.e allPatients an example is "sheet:1,row:11,dataset:allPatients"
	 * 
