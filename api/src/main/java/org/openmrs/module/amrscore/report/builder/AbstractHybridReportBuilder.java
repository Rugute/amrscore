...
import org.openmrs.module.amrscore.report.HybridReportDescriptor;
...
/**
 * Abstract base class for report builders which build cohort and/or indicator components reports -
 * i.e. one row-per-patient dataset
 */
