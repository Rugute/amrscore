...
public abstract class AbstractPatientWrapper extends AbstractPersonWrapper<Patient> {
	...
	public List<Encounter> allEncounters(EncounterType type) {
		return Context.getEncounterService().getEncounters(target, null, null, null, null, Collections.singleton(type),
	...
	public List<Encounter> allEncounters(Form form) {
		return Context.getEncounterService().getEncounters(target, null, null, null, Collections.singleton(form), null,
		    null, null, null, false);
	}
