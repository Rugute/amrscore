...
import org.openmrs.module.amrscore.AbstractEntityDescriptor;
import org.openmrs.module.amrscore.UiResource;
import org.openmrs.module.amrscore.app.AppRestrictedDescriptor;
import org.openmrs.module.metadatadeploy.MetadataUtils;

import java.util.Set;

/**
 * Describes how a form can be used in the EMR. Each form should have a component of this type in
...
public class FormDescriptor extends AbstractEntityDescriptor<Form> implements AppRestrictedDescriptor {
	...
	/**
	 * @see AbstractEntityDescriptor#getTarget()
	 */
	@Override
	...
	/**
	 * @see AppRestrictedDescriptor#getApps()
	 */
	@Override
	...
	/**
	 * @see AppRestrictedDescriptor#setApps(Set)
	 */
	@Override
