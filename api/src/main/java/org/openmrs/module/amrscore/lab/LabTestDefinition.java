...
package org.openmrs.module.amrscore.lab;
...
public class LabTestDefinition {
	...
	/**
	 * Sets the concept reference
	 * 
	 * @param concept the concept reference
	 */
	public void setConcept(ConceptReference concept) {
